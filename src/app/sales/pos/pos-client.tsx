...
export function PosClient({
  ...
  const handleSubmit = useCallback(async () => {
    ...
    if (!validItems.length) { toast.warning('Add at least one item'); return }
    if (finalTotal <= 0) { toast.warning('Enter a valid total'); return }
    if (payMode === 'SPLIT') {
      const c = parseFloat(cashAmt) || 0, n = parseFloat(netAmt) || 0
      if (Math.abs(finalTotal - (c + n)) > 0.01) { toast.warning('Cash + Network must equal total'); return }
    }
    if (payMode === 'CREDIT' && !customerId && (!customerName.trim() || !customerPhone.trim())) {
      toast.warning('Customer name and phone required for credit'); return
    }
    setLoading(true)
    try {
      ...
      resetForm()
      router.refresh()
    } catch (e) { console.error(e); toast.error('Failed to record sale') }
  ...
  // ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Keyboard shortcuts legend ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
  const shortcuts = [
    { key: '/', label: 'Focus item search' },
    { key: 'F2', label: 'Focus item search' },
    { key: 'ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬Ëœ ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬Å“', label: 'Navigate item list' },
    { key: 'Enter', label: 'Add highlighted item' },
    { key: 'Ctrl+1ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“6', label: 'Select payment method' },
    { key: 'F4', label: 'Focus total amount' },
    { key: 'F9', label: 'Record sale' },
    { key: 'Ctrl+Enter', label: 'Record sale' },
    { key: 'Ctrl+K', label: 'Clear cart' },
  ...
  return (
    <>
      ...
      <div className="h-screen flex flex-col bg-[#F4F6F9] overflow-hidden font-sans">
        ...
        <header className="bg-white border-b border-gray-200 px-5 py-2.5 flex items-center justify-between shrink-0 shadow-sm z-10">
          ...
          <div className="flex items-center gap-1 bg-gray-100 rounded-xl p-1">
            {([['pos', 'POS', ShoppingCart], ['sales', 'Today', History], ['credit', 'Credit', CreditCard]] as const).map(([tab, label, Icon]) => (
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => setShowShortcuts(v => !v)} title="Keyboard shortcuts (?)"
              ...
              <Keyboard size={13} /> <span className="hidden lg:inline">Shortcuts</span>
            </button>
        ...
        {/* ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ TODAY'S SALES TAB ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ */}
        {activeTab === 'sales' && (
            ...
            <div className="max-w-2xl mx-auto space-y-3">
              ...
              {allTodaySales.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-48 text-gray-300">
                  <Receipt size={32} className="mb-2" /><p className="text-xs font-semibold">No transactions today</p>
                </div>
              ) : (
                    ...
                    <div key={tx.id} onClick={() => tx.invoiceNumber && setSelectedInvoice(tx.invoiceNumber)}
                      ...
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          <p className="text-sm font-semibold text-gray-900 truncate">{tx.description || (tx.type === 'SALE' ? 'Sale' : 'Return')}</p>
                          <p className="text-xs text-gray-400 font-mono">{tx.invoiceNumber || `#${tx.id}`} Ãƒâ€šÃ‚Â· {format(new Date(tx.createdAt), 'h:mm a')}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2 shrink-0 pl-3">
                        ...
                        <span className={cn('text-sm font-black tabular-nums', tx.type === 'RETURN' ? 'text-rose-600' : 'text-gray-900')}>
                          {tx.type === 'RETURN' ? '-' : '+'}{tx.amount.toFixed(2)} <span className="text-[10px] font-bold text-gray-400">SAR</span>
                        </span>
        ...
        {/* ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ CREDIT TAB ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ */}
        {activeTab === 'credit' && (
          <div className="flex-1 overflow-y-auto p-5">
            <div className="max-w-2xl mx-auto space-y-3">
        ...
        {/* ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ POS TAB: balanced split-panel ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ */}
        {activeTab === 'pos' && (
          <div className="flex-1 flex justify-center overflow-hidden bg-gray-100/50 sm:p-4 lg:p-6">
            <div className="flex w-full max-w-[1000px] bg-white sm:rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden border border-gray-200/60">
              ...
              {/* LEFT: Item Search ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â fixed width sidebar */}
              ...
              <div className="px-4 py-3 border-b border-gray-100 bg-white">
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Search item name or SKUÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ (Press / to focus)"
                    value={search}
                ...
                <div className="flex items-center justify-between mt-1.5 px-0.5">
                  <p className="text-[10px] text-gray-400 font-medium">{filteredItems.length} items</p>
                  {cart.length > 0 && <p className="text-[10px] font-bold text-emerald-600">{cart.reduce((s,c)=>s+c.quantity,0)} in cart Ãƒâ€šÃ‚Â· {cartSubtotal.toFixed(2)} SAR</p>}
                </div>
              </div>

              {/* Item list */}
              <div ref={itemListRef} className="flex-1 overflow-y-auto divide-y divide-gray-50">
                {filteredItems.length === 0 && (
                  <div className="flex flex-col items-center justify-center h-40 text-gray-300">
                    <Package size={28} className="mb-2" /><p className="text-xs font-medium">No items found</p>
                  </div>
                )}
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="flex items-center gap-2 mt-0.5">
                            ...
                            <span className={cn('text-[9px] font-black uppercase px-1.5 py-0.5 rounded-full',
                              ...
                              {oos ? 'Out of stock' : `${item.currentStock} ${item.unit}`}
                            </span>
                          </div>
                        </div>
                      </div>
                      <span className="text-sm font-black text-gray-800 tabular-nums shrink-0 pl-3">
            ...
            {/* RIGHT: CART + PAYMENT PANEL ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â flex-1 main focus */}
            <div className="flex-1 flex flex-col bg-[#F4F6F9] overflow-hidden">
              
              {/* Cart Items */}
              <div className="flex-1 overflow-y-auto">
                <div className="flex items-center justify-between px-4 py-2.5 bg-white border-b border-gray-200 sticky top-0 z-10">
                  <div className="flex items-center gap-2">
                    ...
                    {cart.map(item => (
                      <div key={item.itemId} className="p-3">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs text-gray-400 font-bold">ÃƒÆ’Ã¢â‚¬â€</span>
                          {/* Price edit */}
              ...
              <div className="shrink-0 bg-white border-t-2 border-gray-100 p-4 space-y-3.5 z-10 shadow-[0_-4px_10px_rgba(0,0,0,0.02)]">
                ...
                {cart.length > 0 && (
                  <div className="bg-gray-50 rounded-xl p-3 border border-gray-100 space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-black text-gray-900 tabular-nums">{cartSubtotal.toFixed(2)} SAR</span>
                    </div>
                    <div className="flex items-center gap-2">
                    ...
                    {parseFloat(discountPct) > 0 && (
                      <div className="flex items-center justify-between pt-1">
                        ...
                        <span className="text-xs font-black text-rose-500 tabular-nums">-{discountAmt.toFixed(2)} SAR</span>
                      </div>
                    )}
                  </div>
                )}
                ...
                <div>
                    ...
                    <PopoverTrigger render={
                      <button className={cn('flex w-full items-center justify-between h-11 rounded-xl border px-3.5 text-sm font-semibold transition-colors',
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="truncate">{customerId ? (customerList.find(c=>c.id===customerId)?.name||customerName) : `Customer${payMode==='CREDIT'?' *':' (opt)'}`}</span>
                        </div>
                      ...
                      {quickAddMode ? (
                        <div className="p-4 space-y-3">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-black uppercase tracking-widest text-violet-600 flex items-center gap-1.5"><UserPlus size={14} /> New Customer</span>
                          </div>
                          <Input value={customerSearch} onChange={e=>setCustomerSearch(e.target.value)} placeholder="Full name" className="h-10 rounded-xl font-bold text-sm" autoFocus />
                          ...
                          <button type="button" disabled={!customerSearch.trim()||quickAddSaving}
                            onClick={async () => {
                              ...
                              } catch { toast.error('Failed to create customer') } finally { setQuickAddSaving(false) }
                            }}
                            ...
                            {quickAddSaving ? '...' : <><UserPlus size={14} /> Save & Select</>}
                          </button>
                        </div>
                      ) : (
                        <Command>
                          <CommandInput placeholder="Search customer..." className="h-11" value={customerSearch} onValueChange={setCustomerSearch} />
                            ...
                            <CommandGroup>
                              {customerId!==null && (
                                <CommandItem value="__clear__" onSelect={() => { setCustomerId(null); setCustomerName(''); setCustomerPhone(''); setCustomerComboOpen(false) }}
                                  ...
                                  <Check className="mr-2 h-4 w-4 opacity-0" /> Walk-in
                                </CommandItem>
                              )}
                              {customerList.map(c => (
                            ...
                            {customerSearch.trim().length > 0 && (
                              <CommandGroup>
                                <CommandItem value={`__add__${customerSearch}`} onSelect={() => setQuickAddMode(true)}
                                  ...
                                  <UserPlus size={14} className="mr-2 shrink-0" /> Add &ldquo;{customerSearch}&rdquo;
                                </CommandItem>
                              </CommandGroup>
                            )}
                          </CommandList>
                  ...
                  {payMode === 'CREDIT' && !customerId && (
                    <div className="grid grid-cols-2 gap-2 mt-2 animate-in fade-in slide-in-from-top-1">
                      <Input placeholder="Name *" value={customerName} onChange={e=>setCustomerName(e.target.value)} className="h-9 rounded-xl text-sm border-amber-200 focus:border-amber-500" />
                      <Input placeholder="05xxxxxxxx *" value={customerPhone} onChange={e=>setCustomerPhone(e.target.value)} className="h-9 rounded-xl text-sm border-amber-200 focus:border-amber-500" />
                    </div>
                  )}
                  {payMode === 'CREDIT' && (
                ...
                {/* Description */}
                <Input placeholder="Description (optional)" value={description} onChange={e=>setDescription(e.target.value)} className="h-10 rounded-xl text-sm border-gray-200 bg-gray-50" />

                {/* Submit */}
                <button onClick={handleSubmit} disabled={loading || cart.length === 0}
                  className={cn('w-full h-14 mt-1 rounded-2xl font-black text-base text-white uppercase tracking-wider transition-all active:scale-[0.98] shadow-xl flex items-center justify-center gap-2.5 disabled:opacity-50 disabled:cursor-not-allowed',
